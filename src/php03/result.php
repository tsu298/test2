            ...
            <div class="result-cards">
                <div class="result-card">
                    <div class="result-card__img-wrapper">
                        <img class="result-card__img" src="img/national_flag_img/<?php echo $tokyo['national_flag_img']?>" alt="国旗">
                    </div>
                ...
                <div class="result-card">
                    <div class="result-card__img-wrapper">
                        <img class="result-card__img" src="img/national_flag_img/<?php echo $comparison['national_flag_img']?>" alt="国旗">
                    </div>
                    <div class="result-card__body">
